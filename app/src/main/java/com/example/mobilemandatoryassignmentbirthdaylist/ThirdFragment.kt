...
import com.example.mobilemandatoryassignmentbirthdaylist.databinding.FragmentThirdBinding
...
class ThirdFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonAdd.setOnClickListener {
            ...
            val addedPerson = DisplayablePerson(
                id = 0,
                userId = email,
                name = name,
                birthYear = year,
            ...
            Log.d("AddedPerson", "Added $addedPerson")
            PersonsViewModel.addPerson(addedPerson)
